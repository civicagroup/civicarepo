...
//
////    func fetchReps(address: String, completion: @escaping((Representative?) -> Void)) {
//    func fetchReps(completion: @escaping((RepResponse?) -> Void)) {
//
...
//                let repsList = try? decoder.decode(RepResponse.self, from: data)
//                completion(repsList)
//            }
//
////             if let error = error {
